...
1. Re-read `.ai/INDEX.md`.
2. Re-read `.ai/playbooks/CONTEXT_MANAGEMENT.md`.
3. Re-read `.ai/playbooks/HANDOFF_TEMPLATE.md`.
4. Confirm the patch does not create:
   - `.ai/CURRENT_STATE.md`
   - `.ai/NEXT_PATCH_BRIEF.md`
   - `.ai/HANDOFF.md`
5. Confirm new file is stable reusable template content only.
6. Confirm `.ai/INDEX.md` navigation points to `.ai/templates/MUTABLE_CONTEXT_TEMPLATES.md`.
7. Confirm no `README.md`, prompts, `.gitignore`, or `ARCHITECT_RULES.md` changes are included.
8. Confirm no runtime/test/deployment claims are made.
